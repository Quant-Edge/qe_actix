...
// #[post("/klne_candlestick_data")]
// async fn klne_candlestick_data(
//     data: web::Data<AppState>,
//     query: Query<KeyName>,
...
//     // 设置 API 参数
//     let params = rest_api::MarkPriceKlineCandlestickDataParams::builder(param.mode.clone())
//         .build()
//         .unwrap();

//     // 调用 API 方法，替换为实际存在的 get_account_info 方法
//     let response = client.MarkPriceKlineCandlestickDataParams(params).await.map_err(|e| {
//         error!("change_position_mode: {}", e);
//         actix_web::error::ErrorInternalServerError(e)
//     })?;
